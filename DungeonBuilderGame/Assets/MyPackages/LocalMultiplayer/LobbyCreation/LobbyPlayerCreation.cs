...
public class LobbyPlayerCreation : MonoBehaviour
{
    ...
    void CreatePlayer(InputActionAsset newUserInputActions)
    {
        ...
        var localPlayerLobbyInputSetup = newLobbyPlayer.GetComponent<ILocalPlayerLobbyInputSetup>();
    ...
    private GameObject CreatePlayerUI()
    {
        ...
        playerPanel.GetComponent<LocalPlayerLobbyPanel>().SetPlayerIDText($"Player {playerPanels.Count}");
        return playerPanel;
    }
    ...
    public void DestroyPlayerUI(int playerIndex)
    {
        ...
        {
            playerPanels[i].GetComponent<LocalPlayerLobbyPanel>().SetPlayerIDText($"Player {i + 1}");
        }
    }
